...
useEffect(() => {
  fetch("https://script.google.com/a/macros/tec.mx/s/AKfycbxMcrK1WnQYM1JVFHZg9EdscjfAHZWyY6b2iClFGmbw1ZQb9R8VdEPeO4oSYuQ649Hz/exec")
    .then(res => res.json())
    .then(data => {
      console.log("DATOS SHEET:", data);
      setRows(data);
    })
